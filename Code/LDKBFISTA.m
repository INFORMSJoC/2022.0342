...
input_SCAT(:,2) = input_SCAT(:,2) + 1;
input_SAC(:,2) = input_SAC(:,2) + 1; %observation discrete states start with 1 to 6 here.
...
%outfolder = strcat("./EstimatedParam_SCATSEV_", sex, "_Hx", prev_Concussion);
outfolder = strcat("./EstimatedParam_SAC_", sex, "_Hx", prev_Concussion);
